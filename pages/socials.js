  ...
  return (
    <div className="bg-gray-100 h-screen">
      ...
      <h1 className="w-full my-32 text-5xl font-bold leading-tight text-center text-gray-800">My podcast on Spotify</h1>
        ...
        <iframe  data-cookiescript="accepted" alt="Please accept cookie policy first" data-src="https://open.spotify.com/embed-podcast/episode/1V6vNOGx2n2WVjfAwWgoXs" width="100%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </div>
        <h2 className="w-full my-32 text-5xl font-bold leading-tight text-center text-gray-800">Instagram</h2>
        </div>
      </div>
    </div>
  );
